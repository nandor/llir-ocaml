...
CAMLprim value NOINLINE caml_thread_initialize(value unit)   /* ML */
{
...
CAMLprim value NOINLINE caml_thread_cleanup(value unit)   /* ML */
{
...
CAMLprim value NOINLINE caml_thread_new(value clos)          /* ML */
{
  caml_thread_t th;
  st_retcode err;
...
CAMLprim value NOINLINE caml_thread_self(value unit)         /* ML */
{
  if (curr_thread == NULL)
...
CAMLprim value NOINLINE caml_thread_id(value th)          /* ML */
{
  return Ident(th);
}
...
CAMLprim value NOINLINE caml_thread_uncaught_exception(value exn)  /* ML */
{
...
CAMLprim value NOINLINE caml_thread_exit(value unit)   /* ML */
{
...
CAMLprim value NOINLINE caml_thread_yield(value unit)        /* ML */
{
...
CAMLprim value NOINLINE caml_thread_join(value th)          /* ML */
{
...
CAMLprim value NOINLINE caml_mutex_new(value unit)        /* ML */
{
...
CAMLprim value NOINLINE caml_mutex_lock(value wrapper)     /* ML */
{
...
CAMLprim value NOINLINE caml_mutex_unlock(value wrapper)           /* ML */
{
  st_mutex mut = Mutex_val(wrapper);
  st_retcode retcode;
...
CAMLprim value NOINLINE caml_mutex_try_lock(value wrapper)           /* ML */
{
  st_mutex mut = Mutex_val(wrapper);
  st_retcode retcode;
...
CAMLprim value NOINLINE caml_condition_new(value unit)        /* ML */
{
...
CAMLprim value NOINLINE caml_condition_wait(value wcond, value wmut)    /* ML */
{
...
CAMLprim value NOINLINE caml_condition_signal(value wrapper)            /* ML */
{
...
CAMLprim value NOINLINE caml_condition_broadcast(value wrapper)         /* ML */
{
